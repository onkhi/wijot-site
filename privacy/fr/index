...
La présente politique de confidentialité s’applique à l’app iOS « wijot » ainsi qu’à ses pages d’assistance associées.

## 2. Informations traitées par wijot

### 2.1 Contenu des notes et réglages

wijot est une app centrée sur le stockage local.  
Dans l’implémentation actuelle, le contenu des notes et certains réglages sont principalement stockés sur l’appareil de l’utilisateur ou dans l’espace de stockage partagé utilisé par les widgets.

### 2.2 Informations relatives à l’état des achats

wijot utilise StoreKit pour vérifier l’état des abonnements et des achats de licence à vie.  
La facturation, les moyens de paiement et les autres informations de paiement sont gérés par Apple.
...
Nous utilisons les informations ci-dessus aux fins suivantes.

- Fournir et maintenir les fonctionnalités de l’app
- Maintenir la présentation des widgets synchronisée avec les données de l’app
- Refléter l’état des achats, restaurer les achats et afficher l’état du plan
- Répondre aux demandes d’assistance
- Examiner les problèmes et améliorer la qualité de l’assistance
...
Vous pouvez gérer les éléments suivants selon vos besoins.

- Supprimer le contenu des notes dans l’app
